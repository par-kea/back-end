...
public interface FuncionarioRepository extends CrudRepository<FuncionarioModel, Long> {
    ...
    @Query(value = "SELECT * FROM funcionario WHERE funcionario.cc_funcionario = :cc_funcionario",
            nativeQuery = true)
    FuncionarioModel funcionarioPorCedula(@Param("cc_funcionario") String cedula);
